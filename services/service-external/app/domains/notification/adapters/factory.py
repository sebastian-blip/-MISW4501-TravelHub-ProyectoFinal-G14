...
def _load_strategies() -> dict[str, type]:
    if _STRATEGIES:
        return _STRATEGIES
    from app.domains.notification.adapters.email_sms_adapter import EmailSmsAdapter
    from app.domains.notification.adapters.mock_adapter import MockNotificationAdapter
